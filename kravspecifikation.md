...
* **Visuell dokumentvy (WYSIWYG) med testläge:** Konfiguratören ska ha en visuell vy där den valda mallen visas som det färdiga dokumentet – hela sidan med sidhuvud/sidfot, samtliga fasta block (låsta och redigerbara, med mallens typografi) och parameterfält – renderad på samma sätt som i Fred Editor. I vyn ska administratören direkt kunna **testa** mallen utan att lämna Konfiguratören: fylla i parametervärden (inklusive nästlade parametrar vars synlighet styrs av villkoren), skriva i redigerbara block samt infoga och ta bort fraser (fria block). Testet påverkar inte mallens definition och ska kunna återställas. Vyn ska uppdateras direkt när mallen ändras och administratören ska kunna välja vilken behörig organisation dokumentet visas för.
